...
def chat_start():
    ...
    return jsonify({
        ...
        "message":
            ...
            "How can I help you with waste management?"
    })
...
def chat_message():
    ...
    # Later we can connect your actual AI model here.
    ...
    if "plastic" in message_lower:
        ...
        reply = (
            "Plastic waste should generally go into the "
            "dry/recyclable waste stream. Please check your "
            "local recycling rules for the specific plastic item."
        )

    elif "food" in message_lower or "organic" in message_lower:

        reply = (
            "Food and other biodegradable organic waste "
            "usually belongs in the wet/organic waste bin."
        )

    elif "paper" in message_lower:

        reply = (
            "Clean and dry paper can usually go into the "
            "dry/recyclable waste bin."
        )

    elif "glass" in message_lower:

        reply = (
            "Glass should be separated from ordinary waste "
            "and placed in the appropriate recyclable/glass "
            "collection stream where available."
        )

    elif "battery" in message_lower:

        reply = (
            "Batteries should not be placed in regular wet "
            "or dry waste. They should be given to an "
            "authorized e-waste or battery collection point."
        )

    else:

        reply = (
            "I can help you identify waste, choose the "
            "correct bin, understand recycling, and learn "
            "about sustainable waste management."
        )
